...
class TestUser(TestCase):
    ...
    def test_check_password(self):
        ...
        self.assertFalse(
            bcrypt.check_password_hash(user.password, 'notsecret'))
    ...
    def test_edit_messages(self):
        ...
        with self.client:
            ...
            response = self.client.post(
                ...
                data=dict(content="Hello Everyone", user_id=current_user.id),
                follow_redirects=True)
    ...
    def test_cannot_modify_another_users_message(self):
        ...
        with self.client:
            ...
            response = self.client.post(
                '/users/1/messages/1?_method=PATCH',
                data=dict(
                    text="Here are updated comments.",
