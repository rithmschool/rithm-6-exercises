...
class BaseTestCase(TestCase):
    ...
    def test_messages_index(self):
        ...
        self.assertLess(response.status_code, 400)
        self.assertIn(b'Hunter eats rice and chicken every day, where are the veggies dude"', response.data)
        self.assertNotIn(b'hello there my name is jimbobimbopolos', response.data)
    ...
    def test_messages_edit(self):
        ...
        self.assertIn(b'Mark spilled coffee on his laptop, haha', response.data)
    ...
    def test_messages_delete(self):
        ...
        self.assertNotIn(b'Back when Mark Wahlberg was Marky Mark', response.data)
